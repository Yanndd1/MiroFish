...
// Get maxRounds from query params at init to ensure child components receive value immediately
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh without fullscreen loading to prevent flickering
