    ...
    <header class="app-header">
      ...
      <div class="header-right">
        <div class="workflow-step">
          ...
          <span class="step-name">{{ $t('steps.reportGen') }}</span>
        </div>
...
const loadReportData = async () => {
  try {
    ...
    if (reportRes.success && reportRes.data) {
        ...
        if (simRes.success && simRes.data) {
          ...
          if (simData.project_id) {
            ...
            if (projRes.success && projRes.data) {
              ...
              addLog(t('reportView.projectLoadSuccess', { id: projRes.data.project_id }))
      ...
      addLog(t('reportView.getReportFailed', { error: reportRes.error || t('step1.unknownError') }))
    }
  } catch (err) {
...
const loadGraph = async (graphId) => {
  ...
  try {
    ...
    if (res.success) {
      ...
      addLog(t('reportView.graphDataLoadSuccess'))
    }
  } catch (err) {
...
onMounted(() => {
  addLog(t('reportView.initialized'))
  loadReportData()
})
</script>
