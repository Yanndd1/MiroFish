        ...
        <div class="panel-header">
          ...
          <div class="header-right">
            ...
            <div class="action-buttons">
                ...
                <button class="action-btn" @click="toggleFullScreen" :title="isFullScreen ? 'Exit fullscreen' : 'Enter fullscreen'">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyzes document content and automatically generates an ontology structure (entity types + relation types) suitable for opinion simulation
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, split documents into chunks and call the Zep API to build a knowledge graph, extracting entities and relationships
                </div>
              </div>
...
const fetchGraphData = async () => {
  try {
    // Get project info first to obtain graph_id
...
// Process node data
  ...
  simulation.on('tick', () => {
    // Update all edge positions (visible and transparent click areas)
