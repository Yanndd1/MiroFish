    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          ...
          <!-- Simulation rounds config - only shown when config is generated and rounds calculated -->
...
// State
const phase = ref(0) // 0: initializing, 1: generating personas, 2: generating config, 3: complete
...
const autoGeneratedRounds = computed(() => {
  ...
  // Ensure max rounds is not less than 40 (recommended), prevent slider range issues
...
// Calculate total related topics count across all profiles
...
const handleStartSimulation = () => {
  ...
  if (useCustomRounds.value) {
    // Custom rounds from user, pass max_rounds parameter
    params.maxRounds = customMaxRounds.value
    addLog(t('log.startSimCustomRounds', { rounds: customMaxRounds.value }))
  } else {
    // User chose auto-generated rounds, do not pass max_rounds parameter
...
// Start polling progress
      startPolling()
      // Start real-time Profiles fetching
