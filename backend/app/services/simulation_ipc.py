    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: Interview on both platforms in dual-platform simulation, or the single platform in single-platform simulation
            timeout: Timeout in seconds
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                ...
                - None: Interview each Agent on both platforms in dual-platform simulation
            timeout: Timeout in seconds
