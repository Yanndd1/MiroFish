...
class ZepEntityReader:
    ...
    def get_node_edges(self, node_uuid: str) -> List[Dict[str, Any]]:
        """
        Get all related edges of a specified node (with retry mechanism)
        ...
        try:
            ...
            logger.warning(f"Failed to get edges of node {node_uuid}: {str(e)}")
            return []
    ...
    def filter_defined_entities(
        ...
        """
        logger.info(f"Starting to filter entities of graph {graph_id}...")
        ...
        # Filter entities meeting criteria
        filtered_entities = []
        ...
        for node in all_nodes:
            ...
            if enrich_with_edges:
                ...
                # Get basic information of related nodes
                related_nodes = []
    ...
    def get_entity_with_context(
        ...
        """
        Get a single entity with its full context (edges and related nodes, with retry mechanism)
