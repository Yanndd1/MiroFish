...
Handles retry logic for external API calls such as LLM
"""
...
class RetryableAPIClient:
    ...
    def call_batch_with_retry(
        ...
        Args:
            ...
            process_func: Processing function that takes a single item as argument
            exceptions: Exception types to retry on
            continue_on_failure: Whether to continue processing other items after a single item failure
