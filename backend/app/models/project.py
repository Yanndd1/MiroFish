...
Persists project state on the server side to avoid passing large amounts of data between API calls from the frontend
"""
...
class Project:
    ...
    # Ontology information (populated after API 1 generates it)
